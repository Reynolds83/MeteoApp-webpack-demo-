...
var _flippingMeteo = _interopRequireDefault(__webpack_require__(2));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery.default)(document).ready(function () {
  var flippingMeteoWidget = new _flippingMeteo.default((0, _jquery.default)('[data-module="flipping-meteo"]'));
...
var _modernizr = _interopRequireDefault(__webpack_require__(3));

var _loadGoogleMapsApi = _interopRequireDefault(__webpack_require__(4));
...
function () {
  ...
  _createClass(_class, [{
    ...
    key: "testGeolocation",
    value: function testGeolocation() {
      var _this = this;
      ...
      if ("geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(function (position) {
          ...
          (0, _loadGoogleMapsApi.default)({
            key: "AIzaSyAz_BPo9hv9Omuba9B7Kmo7ow81hWOGAUY"
    ...
    key: "geocodeLatLng",
    value: function geocodeLatLng(geocoder, map, infowindow) {
      var _this2 = this;
      ...
      geocoder.geocode({
        ...
        if (status === 'OK') {
          if (results[4]) {
            ...
            _this2.position = pos.substring(0, pos.indexOf(','));
            map.setZoom(11);
    ...
    value: function renderFront() {
      ...
      this.widget.find('div.days ul li').filter(function () {
        return (0, _jquery.default)(this).attr('data-day') === that.day;
      }).addClass('active');
    }
    /**
    ...
    value: function removePreloader() {
      (0, _jquery.default)('.preloader').fadeOut(200, function () {
        (0, _jquery.default)(this).remove();
        (0, _jquery.default)('.container').addClass('active');
      });
    }
    /**
    ...
    key: "addClickSupport",
    value: function addClickSupport() {
      var _this3 = this;

      if ((0, _jquery.default)('html').hasClass('touchevents')) {
        this.widget.find('.container').click(function (e) {
          _this3.widget.find('.card').toggleClass('flipped');
        });
        this.mapSafeClick();
      }
    }
    ...
    value: function getWeatherInfo() {
      ...
      _jquery.default.getJSON("https://query.yahooapis.com/v1/public/yql?q=" + queryCondition + "&format=json", function (data) {
        _this4.degrees = data.query.results.channel.item.condition.temp + '&#176';
        _this4.icon = data.query.results.channel.item.condition.code;
        _this4.condition = data.query.results.channel.item.condition.text;
        var date = data.query.results.channel.item.condition.date;
        _this4.day = date.substring(0, date.indexOf(','));

        _jquery.default.getJSON("https://query.yahooapis.com/v1/public/yql?q=" + queryWindAtmosphere + "&format=json", function (data) {
          _this4.humidity = data.query.results.channel.atmosphere.humidity + '%';
          _this4.wind = 'F at ' + data.query.results.channel.wind.speed + ' mph';

          _this4.renderFront();

          _this4.renderBack();

          _this4.removePreloader();

          _this4.addClickSupport();
        });
      });
    }
  }]);
